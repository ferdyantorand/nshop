                                    ...
                                    <div class="form-group form-float form-group-lg">
                                        <div class="form-line">
                                            ...
                                            <input id="customer_name" type="text" class="form-control"
                                                   name="customer_name" value="{{ $otherData->name }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group form-float form-group-lg">
                                        <div class="form-line">
                                            ...
                                            <input id="customer_email" type="text" class="form-control"
                                                   name="customer_email" value="{{ $otherData->email }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group form-float form-group-lg">
                                        <div class="form-line">
                                            ...
                                            <input id="customer_phone" type="text" class="form-control"
                                                   name="customer_phone" value="{{ $otherData->phone }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group form-float form-group-lg">
                                        <div class="form-line">
                                            ...
                                            <textarea id="customer_address" type="text" class="form-control"
                                                   name="customer_address" readonly>{{ $otherData->address_description }} {{ $otherData->address_street }} </textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group form-float form-group-lg">
                                        <div class="form-line">
                                            ...
                                            <input id="customer_country" type="text" class="form-control"
                                                   name="customer_country" value="Indonesia" readonly>
                                        </div>
                                    </div>
                                </div>
